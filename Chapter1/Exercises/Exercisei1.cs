...
public class Exercisei1 : MonoBehaviour
{
    ...
    exerciseintro1Mover walker;

    void Start()
    {
        // Start is called before the first frame update
        walker = new exerciseintro1Mover();
    }
...
public class exerciseintro1Mover
{
    ...
    public void step()
    {
        ...
        else if (choice > .2f && choice <= .6f)
        {
            location.x--;
        }
        else if (choice > .6f && choice <= .8f)
        {
            location.y++;
        }
        else
